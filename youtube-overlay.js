  ...
  cpo.createPlayerContainer = function() {
    ...
    if($($this.overlayContainer).length === 0) {
      var o = $('<div class="videoPlayerOverlay hide hiddenTransform" id="youtubePlayerOverlay" data-hasloaded="false"></div>'),
          cButton = $('<button id="youtubeOverlayCloser" class="defaultButton closeIcon"><img src="https://s3.ap-south-1.amazonaws.com/choosemybicycle/cmb-website-icons/cancel-close-icons/x-mark-black-icon.svg" class="img-responsive center-block" alt="Close" title="close"/></button>,<button id="youtubeOverlayCloser" class="defaultButton closeIconn"><img src ="./Images/share.png" class="img-responsive center-block" alt="Close" title="close"/></button>,<div class="chatbox-wrapper"><div class="chatbox-toggle"><img src ="./Images/chat.png" class="img-responsive iconn center-block" alt="Close" title="close"/></div><div class="chatbox-message-wrapper"><div class="chatbox-message-header"><div class="chatbox-message-profile"><img src="./Images/lebron.png" alt="profile" class="chatbox-message-image"><div><h4 class="chatbox-message-name">LeBron James</h4><p class="chatbox-message-status">online</p></div></div><div class="chatbox-message-dropdown"><ul class="chatbox-message-dropdown-menu"><li><a href="#">Search</a></li><li><a href="#">Report</a></li></ul></div></div><div class="chatbox-message-content"><div class="chatbox-message-item sent"><span class="chatbox-message-item-text">What do you think about it my guy?</span><span class="chatbox-message-item-time">08:30</span></div><div class="chatbox-message-item received"><span class="chatbox-message-item-text">Bro!! Spiderman is the GOAT!</span><span class="chatbox-message-item-time">08:30</span></div></div><div class="chatbox-message-bottom"><form action="#" class="chatbox-message-form"><textarea rows="1" placeholder="Type message..." class="chatbox-message-input"></textarea><button type="submit" class="chatbox-message-submit"><img src ="./Images/message.png" class=" messageimg bx bx-send"  alt="Close" title="chat"/></button></form></div></div></div>'),
